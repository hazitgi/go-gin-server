...
func (handler *SkillHandler) CreateSkill(ctx *gin.Context) {
	...
	if err != nil {
		common.BadResponse(ctx, "failed to create skill", err.Error())
		return
	}

	common.SuccessResponse(ctx, "success", newSkill)
}

func (handler *SkillHandler) ListSkills(ctx *gin.Context) {
	allSkills, err := handler.skillManager.List()
	if err != nil {
		common.BadResponse(ctx, "failed to get all skills", err.Error())
		return
	}

	common.SuccessResponse(ctx, "success", allSkills)
}
...
func (handler *SkillHandler) SkillDetail(ctx *gin.Context) {
	...
	if err != nil {
		common.BadResponse(ctx, "failed to get skill", err.Error())
		return
	}

	common.SuccessResponse(ctx, "success", skill)
}
...
func (handler *SkillHandler) DeleteSkill(ctx *gin.Context) {
	...
	if !ok {
		common.BadResponse(ctx, "invalid userid", nil)
		return
	}
	...
	common.SuccessResponse(ctx, "deleted Skill", nil)
}
...
func (handler *SkillHandler) UpdateSkill(ctx *gin.Context) {
	...
	if !ok {
		common.BadResponse(ctx, "failed to delete skill", nil)
		return
	}
	...
	if err != nil {
		common.BadResponse(ctx, "failed to update skill", err.Error())
		return
	}
...
func (handler *SkillHandler) CreateSkillGroup(ctx *gin.Context) {
	...
	if err != nil {
		common.BadResponse(ctx, "failed to create Skill Group", err.Error())
		return
	}

	common.SuccessResponse(ctx, "success", newSkillGroup)
}

func (handler *SkillHandler) ListSkillGroups(ctx *gin.Context) {
	skillGroups, err := handler.skillManager.ListGroup()
	if err != nil {
		common.BadResponse(ctx, "failed to get all Skill Groups", err.Error())
		return
	}

	common.SuccessResponse(ctx, "success", skillGroups)
}
...
func (handler *SkillHandler) SkillGroupDetail(ctx *gin.Context) {
	...
	if err != nil {
		common.BadResponse(ctx, "failed to get Skill Group", err.Error())
		return
	}

	common.SuccessResponse(ctx, "success", skillGroup)
}
...
func (handler *SkillHandler) DeleteSkillGroup(ctx *gin.Context) {
	...
	if !ok {
		common.BadResponse(ctx, "invalid Group id", nil)
		return
	}
	...
	common.SuccessResponse(ctx, "deleted Skill Group", nil)
}
...
func (handler *SkillHandler) UpdateSkillGroup(ctx *gin.Context) {
	...
	if !ok {
		common.BadResponse(ctx, "failed to get group id", nil)
		return
	}
	...
	if err != nil {
		common.BadResponse(ctx, "failed to update Skill Group", err.Error())
		return
	}
